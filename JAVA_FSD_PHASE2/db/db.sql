CREATE TABLE `class` (  `id` int NOT NULL AUTO_INCREMENT,  `className` varchar(255) NOT NULL,  `classTeacherName` varchar(255) DEFAULT NULL,  `createdDt` datetime DEFAULT NULL,  `roomNo` varchar(255) DEFAULT NULL,  `sectionName` varchar(255) DEFAULT NULL,  `totalNumberOfStudents` int NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `className` (`className`)) ;
ERROR 1050 (42S01): Table 'class' already exists
mysql> CREATE TABLE `clas` (  `id` int NOT NULL AUTO_INCREMENT,  `className` varchar(255) NOT NULL,  `classTeacherName` varchar(255) DEFAULT NULL,  `createdDt` datetime DEFAULT NULL,  `roomNo` varchar(255) DEFAULT NULL,  `sectionName` varchar(255) DEFAULT NULL,  `totalNumberOfStudents` int NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `className` (`className`))  ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

 INSERT INTO `class` (`id`, `className`, `classTeacherName`, `createdDt`, `roomNo`, `sectionName`, `totalNumberOfStudents`) VALUES(12, '10th Standard', 'Raghavendra', '2022-02-12 21:35:06', '101a', 'A', 30);
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `students_ibfk_1` FOREIGN KEY (`classId`) REFERENCES `class` (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ;
